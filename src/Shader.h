...
public:
	Shader(const std::string& VertexSource, const std::string& TessellationControlSource, const std::string& TessellationEvalSource, const std::string& GeometrySource, const std::string& FragmentSource);
	~Shader();
